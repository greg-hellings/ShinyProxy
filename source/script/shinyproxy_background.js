...
var envinfo = {"qx.application":"shinyproxy.Background","qx.debug":false,"qx.optimization.basecalls":true,"qx.optimization.comments":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.variants":true,"qx.revision":"unknown","qx.theme":"shinyproxy.theme.Theme","qx.version":"1.5"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:shinyproxy_background.d8745537b198.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
qx.Mixin.define(o,{include:[qx.ui.decoration.MSingleBorder,qx.ui.decoration.MBackgroundImage],construct:function(){this._getDefaultInsetsForBorder=this.__pL;
this._resizeBorder=this.__pK;
this._styleBorder=this.__pI;
this._generateMarkup=this.__pJ;
},properties:{innerWidthTop:{check:f,init:0},innerWidthRight:{check:f,init:0},innerWidthBottom:{check:f,init:0},innerWidthLeft:{check:f,init:0},innerWidth:{group:[w,z,n,k],mode:a},innerColorTop:{nullable:true,check:g},innerColorRight:{nullable:true,check:g},innerColorBottom:{nullable:true,check:g},innerColorLeft:{nullable:true,check:g},innerColor:{group:[u,v,x,r],mode:a}},members:{__pH:null,__pI:function(D){var E=qx.theme.manager.Color.getInstance();
D.position=t;
...
}},__pJ:function(G){var J=this._generateBackgroundMarkup(G);
...
G[y]=0;
G[p]=0;
return this.__pH=this._generateBackgroundMarkup(G,J);
},__pK:function(K,L,M){var N=this.getInsets();
L-=N.left+N.right;
M-=N.top+N.bottom;
...
},__pL:function(){return {top:this.getWidthTop()+this.getInnerWidthTop(),right:this.getWidthRight()+this.getInnerWidthRight(),bottom:this.getWidthBottom()+this.getInnerWidthBottom(),left:this.getWidthLeft()+this.getInnerWidthLeft()};
}}});
})();
...
}},members:{__pM:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
},_isInitialized:function(){return !!this.__pM;
},getMarkup:function(e){if(this.__pM){return this.__pM;
...
}},properties:{innerColor:{check:d,nullable:true,apply:i},innerOpacity:{check:o,init:1,apply:i},outerColor:{check:d,nullable:true,apply:i}},members:{__pM:null,_getDefaultInsets:function(){return {top:2,right:2,bottom:2,left:2};
},_isInitialized:function(){return !!this.__pM;
},_applyStyle:function(){},getMarkup:function(){if(this.__pM){return this.__pM;
...
if(qx.ui.decoration.css3.BorderImage.IS_SUPPORTED){this.__pN=new qx.ui.decoration.css3.BorderImage();

if(p){this.__pO(p);
}}else{this.__pN=new qx.ui.decoration.GridDiv(p);
}
if(q!=null){this.__pN.setInsets(q);
}},properties:{baseImage:{check:d,nullable:true,apply:j},insetLeft:{check:o,nullable:true,apply:n},insetRight:{check:o,nullable:true,apply:n},insetBottom:{check:o,nullable:true,apply:n},insetTop:{check:o,nullable:true,apply:n},insets:{group:[k,l,i,e],mode:f}},members:{__pN:null,getMarkup:function(){return this.__pN.getMarkup();
},resize:function(r,s,t){this.__pN.resize(r,s,t);
},tint:function(u,v){},getInsets:function(){return this.__pN.getInsets();
},_applyInsets:function(w,x,name){var y=g+qx.lang.String.firstUp(name);
this.__pN[y](w);
},_applyBaseImage:function(z,A){if(this.__pN instanceof qx.ui.decoration.GridDiv){this.__pN.setBaseImage(z);
}else{this.__pO(z);
}},__pO:function(B){var G,H,J,I;
this.__pN.setBorderImage(B);
...
}},statics:{IS_SUPPORTED:qx.bom.element.Style.isPropertySupported("borderImage")},properties:{borderImage:{check:t,nullable:true,apply:j},sliceTop:{check:h,init:0,apply:j},sliceRight:{check:h,init:0,apply:j},sliceBottom:{check:h,init:0,apply:j},sliceLeft:{check:h,init:0,apply:j},slice:{group:[n,v,a,w],mode:c},repeatX:{check:[i,e,d],init:i,apply:j},repeatY:{check:[i,e,d],init:i,apply:j},repeat:{group:[u,m],mode:c}},members:{__pM:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
},_isInitialized:function(){return !!this.__pM;
},getMarkup:function(){if(this.__pM){return this.__pM;
...
this.__pM=[x,qx.bom.element.Style.compile({"borderImage":o+B+p+C.join(f)+f+D,position:k,lineHeight:0,fontSize:0,overflow:l,boxSizing:r,borderWidth:C.join(b)+g}),y].join(q);
return this.__pM;
...
this.__su=new qx.io.request.Xhr(b,f);
this.__su.set({cache:false});
this.__su.addListener(a,this.__sw,this);
qx.lang.Function.periodical(this.__sv,300000,this);
chrome.proxy.settings.onChange.addListener(qx.lang.Function.listener(this.__sv,this));
this.__sv();
},__sv:function(){this.__su.send();
},__sw:function(e){if(e.getTarget){try{var i=qx.lang.Json.parse(e.getTarget().getResponse());
...
h.register(g,this);
this.__pP=new Array();
},members:{__pP:null,dispatch:function(i,j){if(!qx.lang.Type.isArray(j)&&typeof (j)!=f&&j!=null){this.error("Invalid type passed for BackgroundServiceImpl::dispatch's argument array");
throw b;
return;
}
try{var k=this.__pP[i];
...
},construct:function(){this.__pQ=new Array();
chrome.extension.onRequest.addListener(qx.lang.Function.bind(this.dispatch,this));
},members:{__pQ:null,dispatch:function(k,l,m){var q=this.__pQ[k.service];
...
this._setPhase(p);
this.__sx=qx.lang.Function.bind(this._onReadyStateChange,this);
this.__sy=qx.lang.Function.bind(this._onLoad,this);
this.__sz=qx.lang.Function.bind(this._onLoadEnd,this);
this.__sA=qx.lang.Function.bind(this._onAbort,this);
this.__sB=qx.lang.Function.bind(this._onTimeout,this);
this.__sC=qx.lang.Function.bind(this._onError,this);
E.onreadystatechange=this.__sx;
E.onload=this.__sy;
E.onloadend=this.__sz;
E.onabort=this.__sA;
E.ontimeout=this.__sB;
E.onerror=this.__sC;
...
},nullable:true},authentication:{check:B,nullable:true}},members:{__sx:null,__sy:null,__sz:null,__sA:null,__sB:null,__sC:null,__sD:null,__sE:null,_transport:null,_createTransport:function(){throw new Error("Abstract method call");
...
if(this.__sD!==M){this.__sD=M;
this.fireEvent(m,qx.event.type.Data,[this.__sD,N]);
...
this.fireEvent(Q);
},_setPhase:function(R){var S=this.__sE;
this.__sE=R;
...
}},__sF:function(){var V=this.getRequestHeaders();

if(V){qx.lang.Object.getKeys(V).forEach(function(W){this._transport.setRequestHeader(W,V[W]);
},this);
}},__sG:function(){var Y=this.getAuthentication(),X=this._transport;
...
},init:true}},members:{__sH:null,_createTransport:function(){return new qx.bom.request.Xhr();
...
if(typeof D.PARSER[C]===r){return this.__sH=D.PARSER[C];
}return this.__sH=C;
},_getParser:function(){var E=this.__sH;
if(E){return E;
...
qx.Bootstrap.define(d,{construct:function(){this.__sI=qx.Bootstrap.bind(this.__sR,this);
this.__sB=qx.Bootstrap.bind(this.__sU,this);
this.__sQ();
if(window.attachEvent){this.__sJ=qx.Bootstrap.bind(this.__sX,this);
window.attachEvent(m,this.__sJ);
}},statics:{UNSENT:0,OPENED:1,HEADERS_RECEIVED:2,LOADING:3,DONE:4},members:{readyState:0,responseText:r,responseXML:null,status:0,statusText:r,timeout:0,open:function(t,u,v,w,x){if(this.__rc){return;
}this.__sK=false;
this.__sL=false;

if(typeof v==k){v=true;
}this.__sM=v;
if(!this.__sY()&&this.readyState>qx.bom.request.Xhr.UNSENT){this.dispose();
this.__sQ();
}this.__sO.onreadystatechange=this.__sI;

try{if(qx.core.Environment.get(q)){qx.Bootstrap.debug(qx.bom.request.Xhr,"Open native request with method: "+t+", url: "+u+", async: "+v);
}this.__sO.open(t,u,v,w,x);
}catch(y){if(!qx.util.Request.isCrossDomain(u)){throw y;
}
if(!this.__sM){this.__sN=y;
}
if(this.__sM){if(window.XDomainRequest){this.readyState=4;
this.__sO=new XDomainRequest();
this.__sO.onerror=qx.Bootstrap.bind(function(){this.onreadystatechange();
this.onerror();
this.onloadend();
},this);
...
}}if(qx.core.Environment.get(s)===o&&parseInt(qx.core.Environment.get(n),10)<2&&!this.__sM){this.readyState=qx.bom.request.Xhr.OPENED;
this.onreadystatechange();
}},setRequestHeader:function(z,A){if(this.__rc){return;
}this.__sO.setRequestHeader(z,A);
},send:function(B){if(this.__rc){return;
}if(!this.__sM&&this.__sN){throw this.__sN;
}B=typeof B==k?null:B;
try{if(qx.core.Environment.get(q)){qx.Bootstrap.debug(qx.bom.request.Xhr,"Send native request");
}this.__sO.send(B);
}catch(C){if(!this.__sM){throw C;
}}if(qx.core.Environment.get(s)===o&&!this.__sM){this.__sR();
}this.__sK=true;
if(qx.core.Environment.get(s)===l&&this.timeout===0){this.timeout=10000;
}if(this.timeout>0){this.__sP=window.setTimeout(this.__sB,this.timeout);
}},abort:function(D){if(this.__rc){return;
}this.__sL=true;
this.__sO.abort();

if(this.__sO){this.readyState=this.__sO.readyState;
}
if(D){return;
}this.onabort();
},onreadystatechange:function(){},onload:function(){},onloadend:function(){},onerror:function(){},onabort:function(){},ontimeout:function(){},getResponseHeader:function(E){if(this.__rc){return;
}return this.__sO.getResponseHeader(E);
},getAllResponseHeaders:function(){if(this.__rc){return;
}return this.__sO.getAllResponseHeaders();
},getRequest:function(){return this.__sO;
},dispose:function(){if(this.__rc){return false;
}if(window.detachEvent){window.detachEvent(m,this.__sJ);
}try{this.__sO.onreadystatechange;
}catch(G){return;
}var F=function(){};
this.__sO.onreadystatechange=F;
this.__sO.onload=F;
this.__sO.onerror=F;
this.abort(true);
this.__sO=null;
...
},__sO:null,__sM:null,__sI:null,__sJ:null,__sB:null,__sK:null,__sL:null,__eH:null,__rc:null,__sP:null,__sN:null,__sQ:function(){this.__sO=this._createNativeXhr();
this.__sO.onreadystatechange=this.__sI;
this.__rc=this.__sK=this.__sL=false;
},__sR:function(){var I=this.__sO,J=true;
...
if(this.readyState===qx.bom.request.Xhr.DONE&&this.__sL&&!this.__sK){return;
}if(!this.__sM&&(I.readyState==2||I.readyState==3)){return;
}this.status=0;
...
}}},__sS:function(){var L=this;
if(qx.core.Environment.get(s)==p&&qx.core.Environment.get(n)<8){if(this.__sM&&!this.__sK&&this.readyState>=qx.bom.request.Xhr.LOADING){if(this.readyState==qx.bom.request.Xhr.LOADING){return ;
}
...
this.__sT();
},__sT:function(){if(this.readyState===qx.bom.request.Xhr.DONE){window.clearTimeout(this.__sP);
if(this.__eH){this.ontimeout();
if(qx.core.Environment.get(s)===l){this.onerror();
}this.__eH=false;
}else{this.statusText?this.onload():this.onerror();
}this.onloadend();
}},__sU:function(){var M=this.__sO;
...
}},__sW:function(){if(qx.core.Environment.get(s)==p&&(this.getResponseHeader(a)||r).match(/[^\/]+\/[^\+]+\+xml/)&&this.responseXML&&!this.responseXML.documentElement){var O=new window.ActiveXObject(g);
O.async=false;
O.validateOnParse=false;
O.loadXML(this.responseText);
this.responseXML=O;
}},__sX:function(){try{if(this){this.dispose();
}}catch(e){}},__sY:function(){var name=qx.core.Environment.get(s);
