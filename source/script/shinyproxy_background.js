...
var libinfo = {"__out__":{"sourceUri":"script"},"chrome":{"resourceUri":"resource","sourceUri":"script","version":"trunk"},"qx":{"resourceUri":"resource","sourceUri":"script","version":"1.5"},"shinyproxy":{"resourceUri":"resource","sourceUri":"script","version":"trunk"}};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:shinyproxy_background.f81ead680dea.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
qx.Mixin.define(o,{include:[qx.ui.decoration.MSingleBorder,qx.ui.decoration.MBackgroundImage],construct:function(){this._getDefaultInsetsForBorder=this.__lz;
this._resizeBorder=this.__ly;
this._styleBorder=this.__lw;
this._generateMarkup=this.__lx;
},properties:{innerWidthTop:{check:f,init:0},innerWidthRight:{check:f,init:0},innerWidthBottom:{check:f,init:0},innerWidthLeft:{check:f,init:0},innerWidth:{group:[w,z,n,k],mode:a},innerColorTop:{nullable:true,check:g},innerColorRight:{nullable:true,check:g},innerColorBottom:{nullable:true,check:g},innerColorLeft:{nullable:true,check:g},innerColor:{group:[u,v,x,r],mode:a}},members:{__lv:null,__lw:function(D){var E=qx.theme.manager.Color.getInstance();
D.position=t;
...
}},__lx:function(G){var J=this._generateBackgroundMarkup(G);
...
G[y]=0;
G[p]=0;
return this.__lv=this._generateBackgroundMarkup(G,J);
},__ly:function(K,L,M){var N=this.getInsets();
L-=N.left+N.right;
M-=N.top+N.bottom;
...
},__lz:function(){return {top:this.getWidthTop()+this.getInnerWidthTop(),right:this.getWidthRight()+this.getInnerWidthRight(),bottom:this.getWidthBottom()+this.getInnerWidthBottom(),left:this.getWidthLeft()+this.getInnerWidthLeft()};
}}});
})();
...
}},members:{__lA:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
},_isInitialized:function(){return !!this.__lA;
},getMarkup:function(e){if(this.__lA){return this.__lA;
...
}},properties:{innerColor:{check:d,nullable:true,apply:i},innerOpacity:{check:o,init:1,apply:i},outerColor:{check:d,nullable:true,apply:i}},members:{__lA:null,_getDefaultInsets:function(){return {top:2,right:2,bottom:2,left:2};
},_isInitialized:function(){return !!this.__lA;
},_applyStyle:function(){},getMarkup:function(){if(this.__lA){return this.__lA;
...
if(qx.ui.decoration.css3.BorderImage.IS_SUPPORTED){this.__lB=new qx.ui.decoration.css3.BorderImage();

if(p){this.__lC(p);
}}else{this.__lB=new qx.ui.decoration.GridDiv(p);
}
if(q!=null){this.__lB.setInsets(q);
}},properties:{baseImage:{check:d,nullable:true,apply:j},insetLeft:{check:o,nullable:true,apply:n},insetRight:{check:o,nullable:true,apply:n},insetBottom:{check:o,nullable:true,apply:n},insetTop:{check:o,nullable:true,apply:n},insets:{group:[k,l,i,e],mode:f}},members:{__lB:null,getMarkup:function(){return this.__lB.getMarkup();
},resize:function(r,s,t){this.__lB.resize(r,s,t);
},tint:function(u,v){},getInsets:function(){return this.__lB.getInsets();
},_applyInsets:function(w,x,name){var y=g+qx.lang.String.firstUp(name);
this.__lB[y](w);
},_applyBaseImage:function(z,A){if(this.__lB instanceof qx.ui.decoration.GridDiv){this.__lB.setBaseImage(z);
}else{this.__lC(z);
}},__lC:function(B){var G,H,J,I;
this.__lB.setBorderImage(B);
...
}},statics:{IS_SUPPORTED:qx.bom.element.Style.isPropertySupported("borderImage")},properties:{borderImage:{check:t,nullable:true,apply:j},sliceTop:{check:h,init:0,apply:j},sliceRight:{check:h,init:0,apply:j},sliceBottom:{check:h,init:0,apply:j},sliceLeft:{check:h,init:0,apply:j},slice:{group:[n,v,a,w],mode:c},repeatX:{check:[i,e,d],init:i,apply:j},repeatY:{check:[i,e,d],init:i,apply:j},repeat:{group:[u,m],mode:c}},members:{__lA:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
},_isInitialized:function(){return !!this.__lA;
...
this.__lA=[x,qx.bom.element.Style.compile({"borderImage":o+B+p+C.join(f)+f+D,position:k,lineHeight:0,fontSize:0,overflow:l,boxSizing:r,borderWidth:C.join(b)+g}),y].join(q);
return this.__lA;
...
(function(){var a="shinyproxy.Background";
...
var b=new shinyproxy.backend.ProxyServiceImpl();
}}});
})();
...
h.register(g,this);
this.__lD=new Array();
},members:{__lD:null,dispatch:function(i,j){if(!qx.lang.Type.isArray(j)&&typeof (j)!=f&&j!=null){this.error("Invalid type passed for BackgroundServiceImpl::dispatch's argument array");
throw b;
return;
}
try{var k=this.__lD[i];
...
},construct:function(){this.__lE=new Array();
chrome.extension.onRequest.addListener(qx.lang.Function.bind(this.dispatch,this));
},members:{__lE:null,dispatch:function(k,l,m){var q=this.__lE[k.service];
...
}catch(l){}if(!k){this.__lH();
}else{if(k.version!=this.__lG){k=this.__lI(k);
}this.__lF=new qx.type.Array();
this.__lF.append(k.entries);
}},members:{__lF:null,__lG:1,list:function(){return this.__lF;
...
},get:function(o){if(o<this.__lF.length)return this.__lF[o];
else return null;
...
var t=false;
this.__lF.forEach(function(u,v){if(u.key==r){this.__lF[v]=s;
t=true;
}},this);
this.__lF.push(s);
this.__lH();
},clear:function(){this.__lF=new qx.type.Array();
this.__lH();
},__lH:function(x){var w;

if(!x)w={version:this.__lG,entries:this.__lF};
else w=x;
localStorage.setItem(j,qx.lang.Json.stringify(w));
},__lI:function(y){y={version:this.__lG,entries:[]};
this.__lH(y);
return y;
}}});
})();
